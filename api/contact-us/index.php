...
<form action="/jobs/#wpcf7-f295-o1" method="post" class="wpcf7-form init" enctype="multipart/form-data" novalidate="novalidate" data-status="init">
   <div class="labelanim labelanimBox">
    ...
    <div class="labelanim labelanimBox">
        ...
        <label style="color: white !important;">Subject *</label>
    </div>
    <div id="messageBox">
        <p>message</p>
    ...
    <div class="btn blanc"><button type="submit" class="wpcf7-form-control wpcf7-submit">Submit</button></div>
                                ...
                                <div class="blocCont hideMO texteCourant textJust">
                                    <p class="lineBefore hideMO">
										...
										West Midlands<br><br>
										B1 2HF<br><br>
										London Office: <a href="tel:02034116463" style="color:white">0203 4116 463</a><br><br>
										Birmingham Office: <a href="tel:0044121 2705 548" style="color:white">0121 2705 548</a><br><br>
										MOBILE NUMBER: <a href="tel:00447949 959 299" style="color:white">07949 959 299</a>  
                                    </p>
