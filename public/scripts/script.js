;(function(root, factory) {
    ...
    //   tailleBgMobile();
      $(window).resize(function() {
        ...
        if ( wW < 960 ) { 
            ...
            $('.barba-container').css('height','100%')
        }
      })
      // DETECT SCROLL ?
      ...
      function hauteurCol() { 
          ...
          if ( $('.barba-container:last-child #menuVI').hasClass('actif') && winWidth > 959 ) { 
            ...
            //   var size = Math.ceil(calcHauteur) + 'px';
              $('.barba-container:last-child .menuVertical a').css('height','300px'); 
             }
      ...
      function mouseEvents() {
          ...
          $('.sendyourcv').click(function(e){ 
              ...
              var title = $(this).closest('.jobItem').find('.titreArticle').html(),
                  ...
                  inputTitle = $('input[name=job-title]');
  ...
  function scrollEvents() {
      ...
      function fix_vh() {
          ...
          $('.barba-container:last-child #colDroite1.menuVertical').css({ top: 0 });
          $('.barba-container:last-child #colDroite2.menuVertical').css({ top: 0 });
